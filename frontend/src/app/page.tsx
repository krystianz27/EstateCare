    ...
    <div className="relative h-screen">
      ...
      <main className="flex-center relative z-10 h-full bg-black/15">
        <div className="text-center">
          <h1
            className="mb-4 font-robotoSlab text-4xl font-semibold 
          ...
          <Link href="/register" prefetch={false}>
            <button className=" rounded-3xl bg-asparagus px-4 py-2 text-lg font-semibold text-white text-opacity-80 hover:bg-lime-600 sm:px-6 sm:text-2xl">
